...
export default React.memo(function RepoCard({ repo, bookmarked, onToggleBookmark }: Props) {
    ...
    return (
        <article
            className="bg-white rounded-xl shadow p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full max-w-6xl mx-auto transition-all duration-200 hover:shadow-md"
        >
            {/* Avatar */}
            <img
            ...
            <div className="flex flex-col flex-1 min-w-0 w-full">
                ...
                <div className="mt-3 flex flex-wrap justify-center sm:justify-between items-center gap-3 text-sm text-gray-600">
                    ...
                    <button
                        ...
                        className={`inline-flex items-center justify-center gap-1.5 px-4 py-1.5 rounded-md font-medium border transition-colors duration-200 ${bookmarked
